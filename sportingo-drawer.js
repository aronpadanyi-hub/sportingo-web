...
.sfd-btn-ertekeles:hover {
  background: rgba(26,143,193,.09);
  border-color: #1a8fc1;
  box-shadow: 0 0 0 3px rgba(26,143,193,.1);
}
.sfd-review-info {
  display: inline-block; margin-top: 6px;
...
.sfd-ert-card:hover {
  ...
  box-shadow: 0 8px 28px rgba(10,22,40,.11);
  border-color: rgba(26,143,193,.25);
}
/* Bal oldali accent csík rating szerint */
.sfd-ert-card::before {
  content: '';
  position: absolute;
  ...
  background: #d4e8f0; /* default: semleges */
}
.sfd-ert-card[data-rating="5"]::before { background: linear-gradient(180deg, #2dbf7e, #1a9960); }
.sfd-ert-card[data-rating="4"]::before { background: linear-gradient(180deg, #1a8fc1, #0f6a94); }
.sfd-ert-card[data-rating="3"]::before { background: linear-gradient(180deg, #1a8fc1, #2dbf7e); }
.sfd-ert-card[data-rating="2"]::before { background: linear-gradient(180deg, #f59e0b, #e67e22); }
.sfd-ert-card[data-rating="1"]::before { background: linear-gradient(180deg, #ef4444, #c0392b); }
/* Kiemelt (első) review */
.sfd-ert-card:first-child {
  background: linear-gradient(135deg, rgba(26,143,193,.05), rgba(45,191,126,.05));
  border-color: rgba(26,143,193,.22);
}
.sfd-ert-card-top {
  display: flex; align-items: flex-start;
  justify-content: space-between; gap: 10px; margin-bottom: 6px;
}
.sfd-ert-card-nev { font-weight: 700; font-size: .9rem; color: #0a1628; flex: 1; min-width: 0; }
.sfd-ert-card-meta { font-size: .73rem; color: #94a3b8; margin-top: 4px; font-weight: 500; }
.sfd-ert-card-preview {
  font-size: .8rem; color: #3a5060; margin-top: 8px;
...
.sfd-ert-stars {
  ...
  text-shadow: 0 1px 3px rgba(245,158,11,.25);
}
.sfd-ert-cimke {
  ...
  border: 1px solid rgba(26,143,193,.15);
  transition: background .18s;
}
.sfd-ert-cimke:hover { background: rgba(26,143,193,.2); }
.sfd-ert-cooldown {
  display: inline-flex; align-items: center; gap: 4px;
  font-size: .72rem; color: #94a3b8; margin-top: 6px;
}
.sfd-ert-cta-wrap { margin-top: 12px; }
.sfd-ert-elvalaszto {
...
/* ── Kiemelt értékelés badge – első meglévő kártya ::after ── */
#sfd-ert-meglevo-list .sfd-ert-card:first-child::after {
  content: '⭐ Legfrissebb';
  position: absolute;
  top: 10px; right: 14px;
  font-size: .6rem; font-weight: 700;
  color: #1a8fc1;
  background: rgba(26,143,193,.1);
  border: 1px solid rgba(26,143,193,.2);
  border-radius: 999px;
  padding: 2px 8px;
  pointer-events: none;
}

/* ── Google auth hint – privát mód tipp ── */
.sp-auth-hint {
  display: flex;
